			...
			<div class="card">
				<form action="/shop/admin/editProduct.do" method="post" onsubmit="return saveEditProduct()">
					...
					<div class="row mb-3 justify-content-center">
						...
						<div class="col-5">
							<fmt:formatDate value="${product.begindate}" type="date" pattern="yyyy-MM-dd" var="formatBeginDate" />
							<input type="date" name="begin_date" id="beginDate" class="form-control" value="${formatBeginDate}" required />
						</div>
						<div class="col-5">
							<fmt:formatDate value="${product.begindate}" type="time" pattern="HH:mm" var="formatBeginTime" />
							<input type="time" name="begin_time" id="beginTime" class="form-control" value="${formatBeginTime}" required />
						</div>
					</div>
					<div class="row mb-3 justify-content-center">
						<div class="col-10">
						...
						<div class="col-5">
							<fmt:formatDate value="${product.enddate}" type="date" pattern="yyyy-MM-dd" var="formatEndDate" />
							<input type="date" name="end_date" id="endDate" class="form-control" value="${formatEndDate}" required />
						</div>
						<div class="col-5">
							<fmt:formatDate value="${product.enddate}" type="time" pattern="hh:mm" var="formatEndTime" />
							<input type="time" name="end_time" id="endTime" class="form-control" value="${formatEndTime}" required />
						</div>
					</div>
					<div class="mb-3 col-10 mx-auto">
